Я использовал Sail для локальной работы сайта.
Чтобы его запустить надо набрать запустить скрипт ./vendor/bin/sail up
Это поднимет все необходимые docker контейнеры.
